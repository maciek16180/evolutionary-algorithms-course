...
t0 = time()
sol, log = es_plus(20, rastrigin, 200000, 150000, .2, 20000, rastrigin_init,
                   logging=True, log_interval=log_interval)
...
print 'Schwefel_plus\n\n'
t0 = time()
sol, log = es_plus(50, schwefel, 100000, 80000, .1, 20000, schwefel_init,
                   logging=True, log_interval=log_interval)
...
print 'Sphere_plus\n\n'
t0 = time()
sol, log = es_plus(200, sphere, 20000, 10000, 1, 20000, sphere_init,
                   logging=True, log_interval=log_interval)
...
t0 = time()
sol, log = es_comma(20, rastrigin, 200000, 150000, 300000, .2, 20000, rastrigin_init,
                    logging=True, log_interval=log_interval)
...
t0 = time()
sol, log = es_comma(50, schwefel, 100000, 80000, 160000, .1, 20000, schwefel_init,
                    logging=True, log_interval=log_interval)
...
print 'Sphere_comma\n\n'
t0 = time()
sol, log = es_comma(200, sphere, 20000, 10000, 30000, 1, 20000, sphere_init,
                    logging=True, log_interval=log_interval)
